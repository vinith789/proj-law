...
[
  ...
  for(const elem of crpc){
    ...
    {
      if(elem.chapter==data)
      {
        var crpc_data = (elem)
        document.getElementById("title").innerHTML = crpc_data.section_titletitle
